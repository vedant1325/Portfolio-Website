...
export const proInfo = [
    ...
    },
    {
        ...
        desc: "It is a weather application that fetches weather data from the OpenWeatherMap API based on user-provided locations. We’ll then display the weather information in a user-friendly manner."
